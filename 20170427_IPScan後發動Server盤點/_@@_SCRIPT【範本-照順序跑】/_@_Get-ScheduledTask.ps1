...
Description
-----------
This command export result in CSV Format

.EXAMPLE
	Get-ScheduledTask.ps1 -ComputerName mgmsrv4 | Export-CSV c:\temp\test.csv
    
    
 Description
-----------
This command read server name in txt fil and export result in CSV Format

    Get-Content .\Server1.txt | ForEach-Object { .\Get-ScheduledTask.ps1 -ComputerName $_ } | Export-CSV .\results2.csv 
