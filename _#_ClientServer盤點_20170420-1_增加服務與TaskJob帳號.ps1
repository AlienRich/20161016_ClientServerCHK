 ...
 $host.ui.RawUI.WindowTitle = “USE-ID ::: $LoginID ::: Connection：$ScanIP ... ”
	...
	if (test-connection $ScanIP -Quiet -Count 3) {
	 ...
	 "$ScanIP,NoResponse,無法Ping..." | Out-File -Append -FilePath ".\_$SubNet.xx_IP-No-response.log"
		...
		$SRVUGList | Export-Csv -NoTypeInformation -Append -Encoding UTF8 -Path .\_List-Local-User-Group.csv
		...
		$GetScheduledTask | Export-Csv -NoTypeInformation -Encoding UTF8 -Append -Path .\_GetScheduledTask.csv
